...
This is the complete guide to **Indago** — both the _why_ and the _how_. By the end you will
understand what the toolkit is, how each of its two engines works under the hood, and how to go
from a single command to a typed, searchable, backend-free content layer. Use the sidebar on the
left to jump between sections; the deep dive on HyperDown's storage model is the heart of it.
