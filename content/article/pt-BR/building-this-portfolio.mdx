...
canonical: ""
cover: "https://zaujulio.vercel.app/glitch-bg-1920.avif"
...
Este post é o primeiro de uma série de três partes. É a **visão geral** — um
passeio recurso a recurso por todo o site e pelas decisões por trás dele. Os dois
posts seguintes mergulham nos dois motores de conteúdo que eu construí para fazer
tudo funcionar: [HyperDown](/pt/articles/what-is-hyperdown) (Markdown/MDX → SQLite)
e [HyperJson](/pt/articles/what-is-hyperjson) (JSON Schema → conteúdo tipado).
