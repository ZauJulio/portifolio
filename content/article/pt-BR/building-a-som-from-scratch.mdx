...
canonical: ""
cover: "https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/cover.webp"
---
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/som_grid.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/neighborhood_gaussian.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/bmu_update_vectors.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/decay_schedule.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/metrics/euclidean_metric.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/metrics/manhattan_metric.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/metrics/chebyshev_metric.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/metrics/cosine_metric.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/lp_unit_balls.png"
    width="25%"
    alt="Bolas unitárias Lp"
  />
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/metrics/minkowski_metric.png"
    width="28.5%"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/pca_init_vs_random.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/mqe_curve.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/square_topology.png"
    alt="Topologia quadrada"
  />
</p>
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/hex_topology.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/umatrix_example.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/umatrix_heatmap.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/umatrix_surface.png"
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ZauJulio/ZSOM/v2.0.0/__docs__/article/activation_heatmap.png"
...
```mermaid
flowchart TB
  SOM(["SOM treinado"]) --> P1["Painel 1 · Dados + projeções do BMU<br/>vetores de erro, encurtando no treino"]
  SOM --> P2["Painel 2 · Grade de pesos + U-Matrix<br/>geometria e estrutura de clusters juntas"]
  SOM --> P3["Painel 3 · Mapa de ativação<br/>frequência de BMU → nós mortos e cobertura"]
  SOM --> P4["Painel 4 · Vista 3D / superfície da U-Matrix<br/>malha sobre a nuvem, ou topologia em relevo"]
...
```mermaid
flowchart TD
  Op["Op crítica por época<br/>matriz de distâncias · update de pesos em lote"] --> C1{"use_numba E topologia<br/>quadrada E Euclidiana?"}
  C1 -->|"sim"| JIT["@njit(parallel=True)<br/>kernel paralelo fundido · ~2–5×"]
  C1 -->|"não · ex.: hex ou cosseno"| NP["broadcast NumPy + linalg.norm<br/>fallback transparente"]
