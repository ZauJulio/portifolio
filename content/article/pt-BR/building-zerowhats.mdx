...
O código completo tá no GitHub — [**ZauJulio/ZeroWhats**](https://github.com/ZauJulio/ZeroWhats). Vale deixar aberto enquanto lê; cada trecho aqui aponta pra código real que dá pra conferir.
...
<UpdateLog>
  <Update date="2026-07-14">
    Sandbox event bridge mais rígido com validação de comandos; adicionado verificador de
    atualizações.
  </Update>
  <Update date="2026-07-08">
    v1.4.0 — Versão dinâmica no About; script de bump alinhando todos os arquivos de release.
  </Update>
  <Update date="2026-07-08">
    v1.3.0 — Toast de download com diálogo salvar-como; refinamentos no MPRIS para evitar entradas
    fantasma de media player.
  </Update>
  <Update date="2026-07-07">
    v1.2.0 — Auto-lock reescrito como idle watcher em Rust (antes era um `setTimeout` por webview
    que não rastreava o app inteiro); ícone de notificação corrigido no Linux.
  </Update>
  <Update date="2026-07-07">
    v1.1.0 — Corretor ortográfico, colar da área de transferência, controles nativos de janela,
    painel de configurações em abas; app-lock reforçado com ícone de notificação e menu na bandeja.
  </Update>
  <Update date="2026-07-06">
    v1.0.0 — Release inicial com avatares em notificações, níveis granulares de privacidade, janelas
    transparentes no macOS; instaladores `.deb`, `.rpm`, `.AppImage`, `.msi`, `.dmg`.
  </Update>
</UpdateLog>
