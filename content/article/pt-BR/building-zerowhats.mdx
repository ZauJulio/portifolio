...
Este post é a história técnica por trás disso: por que a abstração de WebView do Tauri — o wry — venceu Servo, Gecko e Chromium-via-CEF para esse trabalho, e o que a seleção "automática" de WebView realmente significa por baixo dos panos. Por que um cliente de propósito único e sandboxed é uma aposta diferente dos agregadores multi-serviço (Ferdium, Franz) e dos outros wrappers nativos de WhatsApp já existentes (Karere, ZapZap), com uma comparação justa e embasada de todos eles. Como o modelo de segurança tem escopo definido, capability por capability, com o JSON de verdade. Por que Preact e por que Rust. Quanto isso custa de fato, em números reais tirados dos artefatos de release publicados. E — porque é uma pergunta justa para qualquer coisa construída em 2026 — exatamente onde a IA entrou nisso, e onde não entrou.
...
Mais uma prestação de contas honesta, já que é uma pergunta justa para qualquer coisa construída em 2026: onde a IA realmente entrou no ZeroWhats?
