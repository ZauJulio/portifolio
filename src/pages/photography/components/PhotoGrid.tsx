...
import type { Photo } from "@virtus/hyper-json";
      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
        {photos.map((photo) => (
          <button
            type="button"
            key={photo.id}
            className="block w-full text-left break-inside-avoid rounded-xl overflow-hidden border border-gray-800 group relative cursor-pointer"
