...
import type { Language, LanguageProficiency } from "@indago/hyper-json";
  ...
  return (
    <div className="py-4 first:pt-0 last:pb-0">
      ...
      <div className="flex flex-col gap-2 pl-10">
        <LangSkillBar
          skill="speaking"
          value={language.levels.speaking ?? 0}
          color={language.color}
        />
        <LangSkillBar
          skill="listening"
          value={language.levels.listening ?? 0}
          color={language.color}
        />
        <LangSkillBar skill="reading" value={language.levels.reading ?? 0} color={language.color} />
      </div>
    </div>
  );
}
